...
const ALLOWED_FIELDS = new Set([
  ...
  "durationMs",
  "category",
  // A generic, safe numeric count (e.g. rows affected/deleted) — added
  // for app/api/admin/cron/cleanup/route.js's scheduled-cleanup log line.
  // Never anything but a plain number under this key.
  "count",
]);

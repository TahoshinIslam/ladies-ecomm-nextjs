...
function categorizeError(err) {
  ...
  if (err.name === "RateLimitStoreError" || err.name === "ClientIpUnavailableError") return FAILURE_CATEGORIES.DEPENDENCY_UNAVAILABLE;
  if (err.name === "ValidationError" || err.name === "CastError" || err.code === 11000) return FAILURE_CATEGORIES.VALIDATION;
  return FAILURE_CATEGORIES.INTERNAL;
}

...
const configuredIdleMinutes = Number(process.env.SESSION_IDLE_TIMEOUT_MINUTES);
const SESSION_IDLE_TIMEOUT_MS =
  (Number.isFinite(configuredIdleMinutes) && configuredIdleMinutes > 0 ? configuredIdleMinutes : 30 * 24 * 60) * 60 * 1000;

 ...
 * Not implemented yet.
 *
 * The logic already exists in controllers/userController.js, but it is written against
...
const pending = () =>
  NextResponse.json(
    {
      message:
        "This endpoint is not implemented yet — controllers/userController.js still needs to be adapted to a Next.js Route Handler.",
    },
    { status: 501 },
  );

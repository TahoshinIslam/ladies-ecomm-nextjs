...
const upsertListUsers = (args, data) => userApi.util.upsertQueryData("listUsers", args, data);

// `initialData`/`initialParams` come from views/admin/UsersPage.jsx (a real
// Server Component) — see views/admin/OrdersPageClient.jsx's own comment
// for the full explanation of this hydration handoff, identical pattern.
export default function AdminUsersPage({ initialData, initialParams }) {

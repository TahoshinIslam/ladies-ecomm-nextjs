...
// Split out of views/admin/ProductsPage.jsx so it can be `next/dynamic`
// imported from there — this is the single largest chunk of that page's
// client JS (the full single-page product form: variant generator, image
// dropzone, attribute fields, SEO preview, ...) and, unlike the list table
// itself, only ever needs to load once an admin actually clicks "New
// product" or edits a row (ProductsPage.jsx already only renders this
// component when `createOpen || editing` is true — it just used to ship
// as part of the list page's own initial JS regardless of whether it was
// ever opened).
